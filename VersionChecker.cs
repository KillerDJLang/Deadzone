...
namespace DrakiaXYZ.VersionChecker
{
    ...
    public class VersionChecker : Attribute
    {
        ...
        public static bool CheckEftVersion(ManualLogSource Logger, PluginInfo Info, ConfigFile Config = null)
        {
            ...
            int buildVersion = DeadzoneMod.Plugin.TarkovVersion;
            if (currentVersion != buildVersion)
            {
                string errorMessage = $"ERROR: This version of Deadzone v1.1.0 was built for Tarkov {buildVersion}, but you are running {currentVersion}. Please download the correct plugin version.";
